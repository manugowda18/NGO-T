...
export default function Stats() {
  ...
  return (
    <div id="stats">
      <div className="pb-20">
        <div className="mx-auto bg-gradient-to-l from-green-600 to-yellow-700 h-96">
          <div className="mx-auto container w-full flex flex-col justify-center items-center">
            <div className="flex justify-center items-center flex-col">
              ...
              <div className="mt-6 mx-2 md:mx-0 text-center">
                ...
                Sed quis condimentum eros. Aenean a nibh vel augue posuere faucibus. Pellentesque tempus at ante a pretium
                </p>
              </div>
            </div>
          </div>
